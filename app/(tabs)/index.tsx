...
// We must conditionally import the browserAgent to prevent the build from failing
// due to the missing @rork/toolkit-sdk dependency on Vercel's build environment.
// The original import was: import { useBrowserAgent } from '@/services/browserAgent';

// Mock the functionality for web/Vercel where the tool is not available
...
// Select the correct hook based on the platform
